...
public class SwerveDriveTest
{
   ...
   */
  private static final MutLinearVelocity m_velocity       = mutable(MetersPerSecond.of(0));
  /**
   ...
   */
  private static final MutAngularVelocity    m_angVelocity    = mutable(DegreesPerSecond.of(0));
